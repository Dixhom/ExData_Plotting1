...
# plot 1
plot(datetime, data$active_power, xlab="", ylab="Global Active Power", type="l")
...
legend("topright", col=color, lty=c(1,1), legend=leg, bty="n")

# plot 4
plot(datetime, data$reactive_power, xlab="datetime", ylab="Global_reactive_power", type="l", lwd=0.5)
